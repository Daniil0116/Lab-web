<a class="content-block2__article" href='/post?id=<?= $row['post_id'] ?>'>
    <img class="image" src="http://localhost:8001/static/<?= $row['image_url'] ?>" alt="<?= $row['title'] ?>">
    ...
    <div class="most-article__information">
        <div class="most-article__author">
            <img class="author__photo" src="http://localhost:8001/static/<?= $row['author_url'] ?>" alt="<?= $row['author'] ?>">
